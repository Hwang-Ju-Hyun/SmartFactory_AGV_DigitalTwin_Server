...
| Vision 관측 수신 기반 | 카메라 검증 완료·Server 재시작 필요 | 측정된 `[0,0]` body offset의 pose contract `f84eb43ebb6cf7ff`, calibration `ec3d30c62ff66ebe`; Node 1 camera-only 오차 약 15.9 mm/0.2도, 새 HELLO 승인은 Server 재시작 뒤 확인 필요 |
